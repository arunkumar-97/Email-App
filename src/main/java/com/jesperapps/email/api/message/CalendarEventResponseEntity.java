...
public class CalendarEventResponseEntity extends BaseResponse {
	...
	public CalendarEventResponseEntity() {
		super();
	}


	public CalendarEventResponseEntity(CalendarEvent calendarEvent) {
		

		this.calendarEventId = calendarEvent.getCalendarEventId();
		...
		this.eventParticipants = calendarEvent.getEventParticipants();
		this.eventLocation = calendarEvent.getEventLocation();
		this.meetingUrl = calendarEvent.getMeetingUrl();
		this.status = calendarEvent.getStatus();
		this.eventDescription = calendarEvent.getEventDescription();
		this.user = calendarEvent.getUser();
	}
